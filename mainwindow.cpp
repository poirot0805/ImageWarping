...
MainWindow::~MainWindow()
{
    ...
    delete action_choose_idw;
    delete action_choose_rbf;
    delete action_warp;
...
{
    action_new_ = new QAction(QIcon(":/images/new.jpg"), tr("&New"), this);
    ...
    action_choose_idw=new QAction(QIcon(":/images/I.png"),tr("IDW Mode"),this);
    action_choose_idw->setStatusTip(tr("Choose IDW Method and Add Control Points ！more than 3 pairs!"));
    connect(action_choose_idw,&QAction::triggered,imagewidget_,&ImageWidget::SetMode_IDW);
    action_choose_rbf=new QAction(QIcon(":/images/R.png"),tr("RBF Mode"),this);
    action_choose_rbf->setStatusTip(tr("Choose RBF Method and Add Control Points"));
    connect(action_choose_rbf,&QAction::triggered,imagewidget_,&ImageWidget::SetMode_RBF);

    action_warp=new QAction(tr("Start Warp"),this);
    connect(action_warp,&QAction::triggered,imagewidget_,&ImageWidget::StartWarp);
}
...
void MainWindow::CreateMenus()
{
    ...
    menu_edit_->addAction(action_choose_idw);
    menu_edit_->addAction(action_choose_rbf);
    menu_edit_->addAction(action_warp);
}
...
void MainWindow::CreateToolBars()
{
    ...
    toolbar_file_->addSeparator();
    toolbar_file_->addAction(action_choose_idw);
    toolbar_file_->addAction(action_choose_rbf);
    toolbar_file_->addAction(action_warp);
}
